...
# taken from https://github.com/neuralchen/RainNet/blob/main/demo/DatasetRainNet.py on 26.01.2024

class RainNetDataset(data.Dataset):
    def __init__(self,data_path, is_training=True, crop_size_gt=192, upscale_factor=3, 
