...
def trainer(args, train_loader, valid_loader, model,
    ...
    args.experiment_dir = os.path.join('runs',
                                  args.exp_name + '_' + args.trainset  + datetime.now().strftime("_%Y_%m_%d_%H_%M_%S"))
    # set viz dir
        ...
        for batch_idx, item in enumerate(train_loader):
            ...
            if step % args.log_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    reconstructions = model.forward(z=z.cuda(), x_past=x_past.cuda(), state=state,
                    ...
                    predictions = model._predict(x_past.cuda(), state).cuda() # TODO: sample longer trajectories
